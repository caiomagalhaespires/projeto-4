...
function setup() {
  ...
  red = createSprite(380,220,20,50);
  red.addImage( redImage); 
  red.scale = 1;


  green = createSprite(380,220,20,50);
  green.addImage(greenImage); 
  green.scale = 1;

  blue = createSprite(380,220,20,50);
  blue.addImage(blueImage); 
  blue.scale = 1;

  pink = createSprite(380,220,20,50);
...
function blueBalloon() {
  ...
  var blue = createSprite(380,220,20,50);
  blue.addImage(blueImage); 
  blue.scale = 1;
  blue.lifetime = 150;
...
function greenBalloon() }
  var green = createSprite(380,220,20,50);
  green.addImage(greenImage); 
  green.scale = 1;
  green.lifetime = 150;
...
var pink = createSprite(380,220,20,50);
pink.addImage(pinkImage); 
pink.scale = 1;
pink.lifetime = 150;
